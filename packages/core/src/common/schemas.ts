...
export const seatingConfig = schemaForType<DbSeatingConfig>()(
  z.object({
    owner_id: z.string(),
    default_low_seat_warning_level_percent: z.number().default(1),
    ...
    low_seat_warning_level_pct: z
      ...
      .nullable()
      .default(0.1),
    limited_overflow_seating_enabled: z.boolean().nullable().default(false),
...
>()(
  z.object({
    ...
    contact_sales_email: z.string().nullable().optional(),
    contact_sales_url: z.string().nullable().optional(),
    contact_support_email: z.string().nullable().optional(),
    contact_support_url: z.string().nullable().optional(),
    is_setup_complete: z.boolean().nullable().optional(),
    on_access_denied_url: z.string().nullable().optional(),
    on_access_granted_url: z.string().nullable().optional(),
    on_no_seat_available_url: z.string().nullable().optional(),
    on_subscription_not_ready_url: z.string().nullable().optional(),
    on_subscription_canceled_url: z.string().nullable().optional(),
    on_subscription_suspended_url: z.string().nullable().optional(),
    on_subscription_not_found_url: z.string().nullable().optional(),
    on_no_subscriptions_found_url: z.string().nullable().optional(),
