...
export enum MutationProductsCreateRequestBodySeatingConfigSeatingStrategyNameEnum {
    MonthlyActiveUser = "monthly_active_user",
    FirstComeFirstServed = "first_come_first_served"
}

export class MutationProductsCreateRequestBodySeatingConfig extends SpeakeasyBase {
  ...
  seatingStrategyName: MutationProductsCreateRequestBodySeatingConfigSeatingStrategyNameEnum;
}

export class MutationProductsCreateRequestBody extends SpeakeasyBase {
  ...
  seatingConfig: MutationProductsCreateRequestBodySeatingConfig;
}

export class MutationProductsCreateRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "request, media_type=application/json" })
  request: MutationProductsCreateRequestBody;
}

export class MutationProductsCreateDefaultApplicationJSONIssues extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=message" })
  message: string;
}

export class MutationProductsCreateDefaultApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=code" })
  code: string;

  @SpeakeasyMetadata({ data: "json, name=issues", elemType: MutationProductsCreateDefaultApplicationJSONIssues })
  issues?: MutationProductsCreateDefaultApplicationJSONIssues[];

  @SpeakeasyMetadata({ data: "json, name=message" })
  message: string;
}
export enum MutationProductsCreate200ApplicationJSONSeatingConfigSeatingStrategyNameEnum {
    MonthlyActiveUser = "monthly_active_user",
    FirstComeFirstServed = "first_come_first_served"
}

export class MutationProductsCreate200ApplicationJSONSeatingConfig extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=default_low_seat_warning_level_percent" })
  defaultLowSeatWarningLevelPercent: number;
  ...
  @SpeakeasyMetadata({ data: "json, name=seating_strategy_name" })
  seatingStrategyName: MutationProductsCreate200ApplicationJSONSeatingConfigSeatingStrategyNameEnum;
}

export class MutationProductsCreate200ApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=contact_page_url" })
  contactPageUrl: string;
  ...
  @SpeakeasyMetadata({ data: "json, name=seatingConfig" })
  seatingConfig: MutationProductsCreate200ApplicationJSONSeatingConfig;
}

export class MutationProductsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
